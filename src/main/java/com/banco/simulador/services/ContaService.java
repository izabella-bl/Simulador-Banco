...
public class ContaService {
    ...
    public void transferir(Long idOrigem,Long idDestino,double valorTranferencia) throws Exception {
        ...
        Usuarios usuarioDestino = usuarioRepository.findById(idDestino).get();
